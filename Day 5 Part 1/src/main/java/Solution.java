...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        //Filter out all non horizontal/vertical lines
        vectors = vectors.stream().filter(vector -> vector.pointA.x == vector.pointB.x || vector.pointA.y == vector.pointB.y).collect(Collectors.toList());
